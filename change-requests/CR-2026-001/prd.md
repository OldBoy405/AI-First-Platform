...
updated: "2026-07-30T21:27:12+08:00"
version: v0.1.0
refs:
  upstream:
...
| FR-3 | 给已注册的某个 Agent 派发一个 Issue，daemon 能在本机领取并执行完成，执行结果可观察 | 总 PRD §5.1.4；P0-F3 | P0 |
...
| AC-3 | 对任一已注册 Agent 创建一条 Issue 并指派，daemon 在无人工干预下领取该 Issue 并执行完成，执行日志/结果可在系统中查看 | FR-3 |
